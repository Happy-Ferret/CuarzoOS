...
#include "../../../../Code/Piezo/Headers/network.h"
...
QT_MOC_LITERAL(4, 33, 5), // "ready"
QT_MOC_LITERAL(5, 39, 3) // "res"

    },
    "Network\0finished\0\0QNetworkReply*\0ready\0"
    "res"
};
...
void Network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finished((*reinterpret_cast< QNetworkReply*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->ready((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Network::*_t)(QNetworkReply * , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Network::finished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Network::staticMetaObject = {
    { &QNetworkAccessManager::staticMetaObject, qt_meta_stringdata_Network.data,
...
// SIGNAL 0
void Network::finished(QNetworkReply * _t1, QString _t2)
{
