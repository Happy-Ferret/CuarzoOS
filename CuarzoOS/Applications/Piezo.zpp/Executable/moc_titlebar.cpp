...
#include "../../../../Code/Piezo/Headers/titlebar.h"
...
QT_MOC_LITERAL(3, 22, 14), // "minimizeWindow"
QT_MOC_LITERAL(4, 37, 14) // "maximizeWindow"

    },
    "TitleBar\0closeWindow\0\0minimizeWindow\0"
    "maximizeWindow"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::closeWindow)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TitleBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::minimizeWindow)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (TitleBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::maximizeWindow)) {
                *result = 2;
                return;
            }
        }
