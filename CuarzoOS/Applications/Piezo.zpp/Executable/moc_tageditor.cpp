...
#include "../../../../Code/Piezo/Headers/tageditor.h"
...
QT_MOC_LITERAL(1, 10, 11), // "songsEdited"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "pickArtWork"
QT_MOC_LITERAL(4, 35, 11), // "checkValues"
QT_MOC_LITERAL(5, 47, 12) // "applyChanges"

    },
    "TagEditor\0songsEdited\0\0pickArtWork\0"
    "checkValues\0applyChanges"
};
...
void TagEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->songsEdited((*reinterpret_cast< QVariantList(*)>(_a[1]))); break;
        case 1: _t->pickArtWork(); break;
        ...
        {
            typedef void (TagEditor::*_t)(QVariantList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TagEditor::songsEdited)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TagEditor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TagEditor.data,
      qt_meta_data_TagEditor,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void TagEditor::songsEdited(QVariantList _t1)
{
