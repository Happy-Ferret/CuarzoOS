...
#include "../../../../Code/Piezo/Headers/filemanager.h"
...
QT_MOC_LITERAL(1, 12, 15), // "songAddProgress"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 10) // "songAddEnd"

    },
    "FileManager\0songAddProgress\0\0songAddEnd"
};
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->songAddProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->songAddEnd((*reinterpret_cast< QVariantList(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::songAddProgress)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FileManager::*_t)(QVariantList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::songAddEnd)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileManager::songAddProgress(int _t1)
{
...
// SIGNAL 1
void FileManager::songAddEnd(QVariantList _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
