...
#include "../../../../Code/Piezo/Headers/album.h"
...
QT_MOC_LITERAL(1, 6, 12), // "shuffleAlbum"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6), // "artist"
QT_MOC_LITERAL(4, 27, 5), // "album"
QT_MOC_LITERAL(5, 33, 13), // "moreMenuAlbum"
QT_MOC_LITERAL(6, 47, 10), // "shuffleAll"
QT_MOC_LITERAL(7, 58, 7) // "moreAll"

    },
    "Album\0shuffleAlbum\0\0artist\0album\0"
    "moreMenuAlbum\0shuffleAll\0moreAll"
};
...
void Album::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->shuffleAlbum((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->moreMenuAlbum((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 2: _t->shuffleAll(); break;
        case 3: _t->moreAll(); break;
        default: ;
        }
        ...
        {
            typedef void (Album::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Album::shuffleAlbum)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Album::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Album::moreMenuAlbum)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Album::shuffleAlbum(QString _t1, QString _t2)
{
...
// SIGNAL 1
void Album::moreMenuAlbum(QString _t1, QString _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
