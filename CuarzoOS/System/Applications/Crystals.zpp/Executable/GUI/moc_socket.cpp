...
#include "../../../../../../Code/Crystals/headers/socket.h"
...
QT_MOC_LITERAL(1, 7, 9), // "messageIn"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "disconnected"
QT_MOC_LITERAL(4, 31, 10), // "newMessage"
QT_MOC_LITERAL(5, 42, 7) // "disconn"

    },
    "Socket\0messageIn\0\0disconnected\0"
    "newMessage\0disconn"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Socket::messageIn)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Socket::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Socket::disconnected)) {
                *result = 1;
                return;
            }
        }
