/****************************************************************************
** Meta object code from reading C++ file 'titlebarbutton.h'
**
...
#include "../../../../../Code/GUI/Headers/titlebarbutton.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'titlebarbutton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 7), // "animate"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 14) // "animateOpacity"

    },
    "TitleBarButton\0animate\0\0animateOpacity"
};
...
void TitleBarButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TitleBarButton *_t = static_cast<TitleBarButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->animate(); break;
        case 1: _t->animateOpacity(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject TitleBarButton::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_TitleBarButton.data,
...
void *TitleBarButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TitleBarButton.stringdata0))
        return static_cast<void*>(const_cast< TitleBarButton*>(this));
